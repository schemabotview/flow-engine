...
// grid, or two non-backdrop peers that collide. A container/group is a backdrop its
// peers may sit on, so an overlap counts only when neither is a backdrop and neither
