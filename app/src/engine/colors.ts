// Semantic ROLE palette. A concept always wears the same color so color becomes a
// memory cue. Renders as a CALM FILLED block (mixed into a dark base in scene.css),
